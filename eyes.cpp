...
class Eyes {
	private:
		unsigned filteredNumberOfCircles(vector<cv::Vec3f> circles) {
			unsigned count = 0;
	...
	public:
		unsigned numberOfDots(void) { // An unsigned integer makes more sense here than does a signed one, but error reporting becomes harder
